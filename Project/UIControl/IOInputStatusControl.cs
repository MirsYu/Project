...
namespace Project
{
	public partial class IOInputStatusControl : UserControl
	{
		...
		{
			lblinputLight.Image = var ? Properties.Resources.led_green_on_16 : Properties.Resources.led_off_16;

		}
		private void IOInputStatusControl_Load(object sender, EventArgs e)
		{
			if (arrInputIo != null)
			{
