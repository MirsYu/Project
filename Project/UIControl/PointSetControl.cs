...
namespace Project
{
	public partial class PointSetControl : UserControl
	{
		public PointSetControl()
		{
			InitializeComponent();
		}
		...
		private void button_PointDetailed_Click(object sender, EventArgs e)
		{
			if (_PointAggregate != null)
			{
				PointDetailedSetUI pointS = new PointDetailedSetUI(_PointAggregate);
				pointS.ShowDialog();
				InitControl();
			}
		}

		private void PointSetControl_Load(object sender, EventArgs e)
		{
