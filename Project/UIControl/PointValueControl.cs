...
namespace Project
{
	public partial class PointValueControl : UserControl
	{
		...
		//PointVlue加载
		private void PointValueControl_Load(object sender, EventArgs e)
		{
		...
		{
			PointIODelaySetUI frmIo = new PointIODelaySetUI(_PointSet);
			frmIo.Show();
		}
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			WaitUI wait = new WaitUI(pointRun, _PointSet);
			wait.ShowDialog();
