...
namespace Project
{
	...
	public partial class PointAllShowControl : UserControl
	{
		public StationModule tag_StationModule;
		public bool tag_statioOpen;
		public Work tag_Work;
		public List<PointValueControl> tag_PointValueControlList = new List<PointValueControl>();
		...
		{
			for (int i = 0; i < tag_PointValueControlList.Count; i++)
			{
				if (tag_PointValueControlList[i] == sender)
				{
		...
		public void UserControl_ShowAllPoint_HeightLight(object sender, EventArgs e)
		{
			...
			foreach (PointValueControl pv in tag_PointValueControlList)
			{
