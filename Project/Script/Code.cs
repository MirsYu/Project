...
namespace Project
{
	public partial class Code : Form
	{
		...
		public Code()
		{
			...
			textEditor.Load(AppDomain.CurrentDomain.BaseDirectory + "..\\..\\Project\\ScrewTest.cs");
			textEditor.SyntaxHighlighting =
				HighlightingManager.Instance.GetDefinitionByExtension(Path.GetExtension(AppDomain.CurrentDomain.BaseDirectory + "..\\..\\Project\\ScrewTest.cs"));
