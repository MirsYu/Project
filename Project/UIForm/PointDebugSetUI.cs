...
namespace Project
{
	public partial class PointDebugSetUI : Form
	{
		...
		private PointDetailedSetUILabelControl PointLabel;
			...
			try
			{
				...
				if (_StationM != null && !string.IsNullOrEmpty(_StationM.strStationName))
				{
					...
					for (i = 0; i < intInputControlCount; i++)
					{
						if (i == 0)
						{
							IOInputSetLabelControl ioinlab = new IOInputSetLabelControl();
							panel_InputIo.Controls.Add(ioinlab);
							ioinlab.Location = new Point(3, 1);
						}
						IOSetPanelControl inputIo = new IOSetPanelControl();
					...
					for (i = 0; i < intOutputControlCount; i++)
					{
						if (i == 0)
						{
							IOOutputSetLabelControl iooutlb = new IOOutputSetLabelControl();
							panel_OutputIo.Controls.Add(iooutlb);
							iooutlb.Location = new Point(3, 1);
						}
						IOSetPanelControl outputIo = new IOSetPanelControl();
					...
					for (i = 0; i < intPointControlCount; i++)
					{
						if (i == 0)
						{
							PointLabel = new PointDetailedSetUILabelControl(_StationM, intAxisControlCount);
							panel_Point.Controls.Add((Control)PointLabel);
							PointLabel.Location = new Point(85, 18);
						}
						...
						if (_StationM.arrPoint[i].tag_BeginPointAggregateList != null)
						{
							foreach (PointAggregate pa in _StationM.arrPoint[i].tag_BeginPointAggregateList)
							{
								if (IsAdd(pa) == true)
								{
									PointSetControl setP = new PointSetControl();
						...
						{
							PointSetControl setP1 = new PointSetControl();
		...
		{
			AxisSetUI axis = new AxisSetUI(_Worker);
			axis.Show();
			return;
		}
		...
		private void PointDebugSetUI_Load(object sender, EventArgs e)
		{
			InitForm();
		}
		...
		private void button_AddInputIo_Click(object sender, EventArgs e)
		{
			...
			IOSetPanelControl setC = new IOSetPanelControl();
		...
		private void button_AddPoint_Click(object sender, EventArgs e)
		{
			...
			if (intPointControlCount < 1)
			{
				PointLabel = new PointDetailedSetUILabelControl(_StationM, intAxisControlCount);
				panel_Point.Controls.Add((Control)PointLabel);
				PointLabel.Location = new Point(85, 14);
			...
			PointSetControl setC = new PointSetControl();
		...
		private void button_RefreshPoint_Click(object sender, EventArgs e)
		{
			RefreshPoint2();
		}
		...
		public void RefreshPoint2()
		{
			foreach (Control con in panel_Point.Controls)
			{
				if (con is PointDetailedSetControl)
				{
					PointSetControl setP = (PointSetControl)con;
					setP.Refres();
				}
			}
		...
		public void RefreshPoint()
		{
			...
			if (PointLabel != null)
			{
				PointLabel.RefreshControl(intAxisControlCount);
			}
		}

		private void PointDebugSetUI_FormClosing(object sender, FormClosingEventArgs e)
		{
			RestorStationInfo();
		}
		...
		private void button_OneKeySetting_Click(object sender, EventArgs e)
		{
			if (string.IsNullOrEmpty(cboAxisName.Text))
			{
				MessageBoxLog.Show("轴名为空，请选择轴名!");
		...
		private void button_OutputIO_ImportOut_Click(object sender, EventArgs e)
		{
		...
		private void button_InputIO_ImportOut_Click(object sender, EventArgs e)
		{
		...
		private void button_PointStep_ImportOut_Click(object sender, EventArgs e)
		{
			if (DialogResult.OK == saveFileDialog1.ShowDialog())
			{
		...
		private void button_PointStep_ImportIn_Click(object sender, EventArgs e)
		{
		...
		private void button_Axis_ImportIn_Click(object sender, EventArgs e)
		{
		...
		private void button_Axis_Reference_Click(object sender, EventArgs e)
		{
			AxisManageUI axis = new AxisManageUI(_StationM);
			axis.Show();
		}

		private void button_Axis_Refresh_Click(object sender, EventArgs e)
		{
			int i = 0;
			panel_Axis.Controls.Clear();
		...
		private void button_Input_IONoCard_ImportIn_Click(object sender, EventArgs e)
		{
			if (DialogResult.OK == openFileDialog1.ShowDialog())
			{
		...
		private void button_Output_IONoCard_ImportIn_Click(object sender, EventArgs e)
		{
			if (DialogResult.OK == openFileDialog1.ShowDialog())
			{
		...
		private void button_Input_IO_ImportIn_Click(object sender, EventArgs e)
		{
			if (DialogResult.OK == openFileDialog1.ShowDialog())
			{
